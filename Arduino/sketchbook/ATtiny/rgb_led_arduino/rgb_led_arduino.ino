...
Original code from cyragia on Instructables 
(http://www.instructables.com/id/Fading-RGB-LED-Arduino/step3/Code/)
slightly modified by Eric Weinhoffer.
Assembly instructions are available on Make Projects 
(http://makeprojects.com/Project/Use+a+Common+Anode+RGB+LED/3415/).
